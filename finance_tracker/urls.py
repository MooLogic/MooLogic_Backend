...
create_expense,update_expense,delete_expense,total_expense,expense_breakdown,list_expense,generate_profit_snapshot,generate_profit_snapshot_with_alerts, monthly_finance_summary,export_financial_records
...
urlpatterns = [
    ...
    path('monthly-summary/', monthly_finance_summary, name='monthly_finance_summary'),
    path('export/', export_financial_records, name='export_financial_records'),
